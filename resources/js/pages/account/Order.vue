 ...
 *
 * The trail and the "Order SS-000123" H1 come from AccountLayout, off the
 * `breadcrumbs` prop, so this page renders neither.
 */
...
<template>
    ...
    <div class="flex flex-col gap-10">
        ...
        <!--
          The summary rail only splits off at `xl`. This column already sits
          beside the account nav, so at `lg` there is not enough width left for
          a 20rem aside and a readable line of order detail next to it.
        -->
        <div class="grid items-start gap-10 xl:grid-cols-[minmax(0,1fr)_20rem]">
            <div class="flex min-w-0 flex-col gap-12">
                    ...
                    <ol class="mt-4 flex flex-col gap-4 text-sm">
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-foreground">
                                ...
                                <template v-else>
                                    We will pack it and let you know when it is
                                    on its way to you.
                                </template>
                            </span>
                        </li>
                ...
                <section aria-labelledby="order-destination-heading">
                    <SectionHeading
                        ...
                        :title="
                            isCollection ? 'Collection point' : 'Delivering to'
                        "
                    ...
                    >
                        ...
                        <div v-else-if="order.shippingAddress" class="min-w-0">
            ...
            <section
                class="border-rule shadow-card rounded-lg border bg-white xl:sticky xl:top-28"
