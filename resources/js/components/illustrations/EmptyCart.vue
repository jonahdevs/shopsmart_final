<!--
  unDraw's "Empty cart", recoloured by hand onto the storefront palette: ink
  for every dark and every skin tone, `--electric` for the accent, the two
  tints for the fills. Nothing else — a stray rose one scroll above a price
  grid would read as `--sale`, and `--sale` only ever means a discount here.

  Inlined rather than loaded through `<img src>` so it costs no second request
  and can be repainted with the rest of the palette. See NOTICE.md.
-->
<template>
    <svg
        class="h-auto w-full"
    ...
    >
        ...
        <path
            ...
            fill="#0a57eb"
        />
        <rect x="413.2485" y="35.90779" width="140" height="2" fill="#e9f0fe" />
        <rect
            x="513.2485"
            y="37.40779"
            width="2"
        ...
        <polygon
            ...
            fill="#101828"
        />
        <circle cx="156.78851" cy="726.03301" r="17.88673" fill="#101828" />
        <circle cx="333.10053" cy="726.03301" r="17.88673" fill="#101828" />
        <circle cx="540.92726" cy="346.153" r="11.07274" fill="#101828" />
        <path
        ...
        <rect
            ...
            fill="#101828"
        />
        <rect y="745" width="896" height="2" fill="#101828" />
        <path
        ...
        <path
            ...
            fill="#101828"
        />
        <circle cx="625.28185" cy="54.4082" r="38.40579" fill="#101828" />
        <path
        ...
        <path
            ...
            fill="#101828"
        />
        <rect x="60.2485" y="352.90779" width="140" height="2" fill="#e9f0fe" />
        <rect
            x="98.2485"
            y="334.90779"
            width="2"
        ...
        <rect
            ...
            fill="#e9f0fe"
        />
        <rect x="109.2485" y="56.90779" width="140" height="2" fill="#e9f0fe" />
        <rect
            x="209.2485"
            y="58.40779"
            width="2"
        ...
        <rect
            ...
            fill="#e9f0fe"
        />
        <rect x="12.2485" y="252.90779" width="140" height="2" fill="#e9f0fe" />
        <rect
            x="112.2485"
            y="254.40779"
            width="2"
